...
public class TestDict {
  ...
  */
  ...
  public static void main(String[] args) {
    ...
    // Test 2: try to insert another data item with a key already in the
    // dictionary. Should throw an exception.
    ...
    if (test[6])
      try {
        ...
        if (dict.get("answer") != -1) {
          System.out.println("1: " + dict.get("answer"));
          passed = false;
        }

        if (dict.get("record2") != -1) {
          System.out.println("2: " + dict.get("record2"));
          passed = false;
        }
